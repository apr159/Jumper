        ...
        Disposable
{
        ...
        GameMusic music )
    {
        ...
        // do some logging
        Gdx.app.log( JumperGame.LOG, "Playing music: " + music.name() );
    ...
    public void stop()
    {
        if( musicBeingPlayed != null ) {
            Gdx.app.log( JumperGame.LOG, "Stopping current music" );
    ...
    public void setVolume(
        float volume )
    {
        Gdx.app.log( JumperGame.LOG, "Adjusting music volume to: " + volume );
    ...
    public void dispose()
    {
        Gdx.app.log( JumperGame.LOG, "Disposing music manager" );
        stop();
    }
}